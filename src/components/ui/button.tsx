  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl text-sm font-bold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-to-br from-brand-gold to-brand-gold-light text-brand-dark shadow-[var(--shadow-brand)] hover:shadow-[0_15px_50px_-5px_hsl(38_75%_48%/0.5)] hover:scale-[1.02] transition-all",
        "hero-secondary": "bg-gradient-to-br from-brand-black to-brand-dark text-brand-gold border-2 border-brand-gold/20 shadow-lg hover:shadow-[var(--shadow-brand)] hover:scale-[1.02] transition-all",
      },
      size: {
